...
?>
        ...
        <div id="cust-sites" class="tab-content mt-4">
            ...
            <div id="my-c-nav" class="tab-pane active">                    
                ...
                ?>
                    <div class="url-card col-6 <?php get_columns('sites') ?> <?php echo io_sites_before_class($post->ID) ?> col-xxl-10a">
            ...
            if($customize_terms){
                foreach($customize_terms as $c_term){?>
                    <div id="ct-<?php echo $c_term->id ?>" class="customize-sites tab-pane<?php echo ($i_u == 0?' active':'') ?>">                    
                        <div class="site-list row row-sm" data-term_id="<?php echo $c_term->id ?>" >
                        <?php
                        if(io_get_option("tab_ajaxs",false)): //TODO 判断始终为 false，考虑是否开放设置---------------------------------------
                        ...
                        if($c_urls){ 
                            ...
                            ?> 
                            <div id="url-<?php echo $c_url->id ?>" class="url-card sortable col-6 <?php get_columns('sites') ?> col-xxl-10a">
                            ...
                            <?php } ?>
                            <div class="url-card col-6 <?php get_columns('sites') ?> col-xxl-10a add-custom-site" data-term_id="<?php echo $c_term->id ?>" style="display: none">
            ...
            <div id="ct-1" class="tab-pane<?php echo ($i_u == 0?' active':'') ?>">                    
                <div class="row row-sm">
                    ...
                    <div class="url-card col-6 <?php get_columns('sites') ?> col-xxl-10a add-custom-site"  data-term_id="-1" style="display: none">
                        <a class="btn p-0 rounded mb-3" data-toggle="modal" data-target="#addSite" style="background: rgba(136, 136, 136, 0.1);width: 100%;text-align: center;border: 2px dashed rgba(136, 136, 136, 0.5);">
                            <div class="text-lg"  style="padding:0.22rem 0.5rem;">
                                +
                            </div>
            ...
            <div id="my-star" class="tab-pane">            
                <div class="row row-sm my-star-list">   
                    <?php 
                    ...
                    <div class="col-lg-12 customize_nothing_star">
                        <div class="nothing mb-4"><?php _e('您还没有收藏内容！等待你的参与哦 ^_^', 'i_theme' ); ?></div>
                    </div> 
                    <?php }?>
                </div> 
            </div> 
            <div id="my-click" class="tab-pane">            
                <div class="row row-sm my-click-list">   
                ...
                <div class="modal-body">
                    ...
                    <form class="add-custom-site-form" action="javascript:;">
                        <div class="form-row">
                            ...
                            <div class="border-bottom border-color my-4"></div> 
                            ...
                            <div class="col-12 text-center mt-4">
                                ...
                                <button type="button" class="btn-close-fm btn  btn-xs" data-dismiss="modal"><?php _e('取消', 'i_theme' ); ?></button>
                            </div>
                            <div class="col-12 text-center mt-2">
                                <a href="<?php echo esc_url(home_url().'/user/sites') ?>" class="text-xs text-muted"><i class="iconfont icon-upload-wd mr-1"></i><?php _e('导入 chrome 书签', 'i_theme' ); ?></a>
                            </div>
                        </div>
                    </form>
                </div>  
